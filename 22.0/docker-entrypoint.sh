...
sed -i "s|##UPLOAD_MAX_SIZE##|${UPLOAD_MAX_SIZE}|g" /etc/php8/php-fpm.conf
sed -i "s|##APC_SHM_SIZE##|${APC_SHM_SIZE}|g" /etc/php8/conf.d/apcu.ini
sed -i "s/##OPCACHE_MEM_SIZE##/${OPCACHE_MEM_SIZE}/g" /etc/php8/conf.d/00_opcache.ini
